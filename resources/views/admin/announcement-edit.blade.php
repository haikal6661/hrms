        ...
        <div class="row mb-2">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h3 class="card-title col-md-10">Edit Announcement</h3>
                </div>
                <div class="card-body">
                <div class="row">
                        <div class="col">
                        ...
                        <label for=""><span style="color: red;">*</span>Title</label>
                            ...
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$announcement->title}}" required autocomplete="title" autofocus>
                    ...
                    <div class="row">
                        ...
                        <label for="">Status</label>
                            ...
                            <input type="checkbox" name="status_id" class="custom-control-input" id="status_id" onchange="updateLabel()" {{ $announcement->status_id == 2 ? 'checked' : '' }}>
                            <label class="custom-control-label" for="status_id">
                    ...
                    <div class="row">
                        ...
                        <label for=""><span style="color: red;">*</span>Body</label>
                            <textarea name="body" id="editor"  rows="10">{{$announcement->body}}</textarea>
                        </div>
                    </div>
                </form>
                </div>
            ...
            <div class="modal-dialog">
                ...
                @csrf
                    <p>Are you sure you want to update this announcement?</p>
                </div>
                </div>
            ...
            <div class="card-footer clearfix" id="footer">
                <button type="button" style="width: 100px;" class="btn btn-block btn-primary" onclick="submitAnnouncement({{$announcement->id}})"><i class="fas fa-save"></i>
                    Update</button>
            </div>
            </div>
        </div>
