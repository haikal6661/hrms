        ...
        <div class="row mb-2">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    @else
                    <h3 class="card-title col-md-11">Leave entitlement (Days)</h3>
                    @endrole
                            ...
                            <div class="form-group col-md-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="leave[{{$leave->leave_type_id}}]" id="{{$leave->id}}" value="{{$leave->entitlement}}" disabled>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                ...
                <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="row">
                                        <div class="col-4">
                                            <a href="{{route('leave.leave-entitlement-edit', ['id' => $staff->id])}}" role="button" class="btn btn-success btn-sm" title="Edit Entitlement"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </div>
                                </td>
                                @endcan
                ...
                <form id="leave_entitlement">
                    ...
                    <div class="form-group row">
                        ...
                        @foreach ($staffList as $key => $staff)
                            ...
                            <input type="text" class="form-control" name="leave[{{$leave->leave_type_id}}]" id="{{$leave->id}}" value="{{$entitlement->entitlement}}"
